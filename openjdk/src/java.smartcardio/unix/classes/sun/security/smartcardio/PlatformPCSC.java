...
class PlatformPCSC {
    ...
    private static final String[] LIB_TEMPLATES = { "/data/data/com.termux/files/usr/$LIBISA/libpcsclite.so",
                                                    "/data/data/com.termux/files/usr/local/$LIBISA/libpcsclite.so",
                                                    "/data/data/com.termux/files/usr/lib/$ARCH-linux-gnu/libpcsclite.so",
                                                    "/data/data/com.termux/files/usr/lib/arm-linux-gnueabi/libpcsclite.so",
                                                    "/data/data/com.termux/files/usr/lib/arm-linux-gnueabihf/libpcsclite.so" };
