...
public final class PrintServiceLookupProvider extends PrintServiceLookup
    ...
    String[] lpNameComAix = {
      "/data/data/com.termux/files/usr/bin/lsallq",
      "/data/data/com.termux/files/usr/bin/lpstat -W -p|/data/data/com.termux/files/usr/bin/expand|/data/data/com.termux/files/usr/bin/cut -f1 -d' '",
      "/data/data/com.termux/files/usr/bin/lpstat -W -d|/data/data/com.termux/files/usr/bin/expand|/data/data/com.termux/files/usr/bin/cut -f1 -d' '",
      "/data/data/com.termux/files/usr/bin/lpstat -W -v"
    };
    ...
    String[] lpcFirstCom = {
        "/data/data/com.termux/files/usr/bin/lpc status | grep : | sed -ne '1,1 s/://p'",
        "/data/data/com.termux/files/usr/bin/lpc status | grep -E '^[ 0-9a-zA-Z_-]*@' | awk -F'@' '{print $1}'"
    };

    String[] lpcAllCom = {
        "/data/data/com.termux/files/usr/bin/lpc status all | grep : | sed -e 's/://'",
        "/data/data/com.termux/files/usr/bin/lpc status all | grep -E '^[ 0-9a-zA-Z_-]*@' | awk -F'@' '{print $1}' | sort"
    };
    ...
    static int getBSDCommandIndex() {
        String command  = "/data/data/com.termux/files/usr/bin/lpc status all";
    ...
    private PrintService getNamedPrinterNameBSD(String name) {
      ...
      String command = "/data/data/com.termux/files/usr/bin/lpc status " + name + lpcNameCom[cmdIndex];
    ...
    static String getDefaultPrinterNameSysV() {
        ...
        String command = "/data/data/com.termux/files/usr/bin/lpstat -d";
    ...
    private PrintService getNamedPrinterNameSysV(String name) {
        ...
        String command = "/data/data/com.termux/files/usr/bin/lpstat -v " + name;
        String []result = execCmd(command);
    ...
    private String[] getAllPrinterNamesSysV() {
        String defaultPrinter = "lp";
        String command = "/data/data/com.termux/files/usr/bin/lpstat -v|/data/data/com.termux/files/usr/bin/expand|/data/data/com.termux/files/usr/bin/cut -f3 -d' ' |/data/data/com.termux/files/usr/bin/cut -f1 -d':' | /data/data/com.termux/files/usr/bin/sort";
    ...
    static String[] execCmd(final String command) {
        ...
        try {
            ...
            if (isAIX()) {
                cmd[0] = "/data/data/com.termux/files/usr/bin/sh";
                cmd[1] = "-c";
