...
static const char *ZONEINFO_DIR = "/data/data/com.termux/files/usr/share/zoneinfo";
static const char *DEFAULT_ZONEINFO_FILE = "/data/data/com.termux/files/usr/etc/localtime";
#else
