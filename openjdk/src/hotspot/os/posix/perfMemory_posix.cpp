...
//
#define TMP_BUFFER_LEN (35+22)
static char* get_user_tmp_dir(const char* user, int vmid, int nspid) {
  char* tmpdir = "/data/data/com.termux/files/usr/tmp";
#if defined(LINUX)
  ...
  assert(strlen(tmpdir) == 35, "No longer using /data/data/com.termux/files/usr/tmp - update buffer size");
