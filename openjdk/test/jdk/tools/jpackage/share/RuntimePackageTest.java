...
public class RuntimePackageTest {
    ...
    @Test(ifOS = LINUX)
    @Parameter("/data/data/com.termux/files/usr")
    @Parameter("/data/data/com.termux/files/usr/lib/Java")
    ...
    private static PackageTest init(ThrowingSupplier<Path> createRuntime) {
        ...
        .forTypes(PackageType.LINUX_DEB, test -> {
            test.addInstallVerifier(cmd -> {
                ...
                Path copyright = Path.of("/data/data/com.termux/files/usr/share/doc",
                ...
                if (installDir.startsWith("/data/data/com.termux/files/usr/") || installDir.equals("/data/data/com.termux/files/usr")) {
